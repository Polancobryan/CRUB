 ...
 * @author brpol
 */
public class DRegistracion extends javax.swing.JFrame {

    /**
     * Creates new form DRegistracion
     */
    public DRegistracion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\brpol\\OneDrive\\Escritorio\\17 Gifs del Universo para tu Smartphone _ Gifmaniacos_es.gif")); // NOI18N
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
            ...
            String emails = correo.getText();
            String pass = String.valueOf(contraseña.getPassword());
            String pass2 = String.valueOf(confirmar.getPassword());
            ...
            else if(pass == null ? pass2 != null : !pass.equals(pass2))
            {
                ...
                String strSentenciaInsert= String.format("insert into datos(Usuario,Nombre,Apellido,Correo,Numero,Contraseña)"
                        + "values (\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\")",user,Nombre,Apellido,emails,tel,pass);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DRegistracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DRegistracion().setVisible(true);
            }
        });
